...
void APredictedExampleCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APredictedExampleCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &APredictedExampleCharacter::Look);

	}

}

void APredictedExampleCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APredictedExampleCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
